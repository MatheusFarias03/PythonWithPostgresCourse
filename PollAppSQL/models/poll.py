...
class Poll:
    def __init__(self, title:str, owner:str, _id:int = None) -> None:
        self.id = _id
        self.title = title
        self.owner = owner

    def __repr__(self) -> str:
        return f"Poll({self.title!r}, {self.owner!r}, {self.id})" # Will print: Poll('title', 'owner', 1)
